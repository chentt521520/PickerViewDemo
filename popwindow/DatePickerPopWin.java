...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private static final int STYLE_YEAR = 1;
    private static final int STYLE_YEAR_AND_MONTH = 2;
    ...
    public static class Builder {
        ...
        public Builder(Context context, OnDatePickedListener listener, int style) {
            this.context = context;
            this.listener = listener;
            this.style = style;
        }
